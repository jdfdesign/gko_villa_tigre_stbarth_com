...
group :production do
	gem "gko_core", "= 0.3.35", :git => 'git@github.com:jdfdesign/gko_cms3.git'
	gem "gko_auth", "= 0.3.35", :git => 'git@github.com:jdfdesign/gko_cms3.git'
	gem "gko_images", "= 0.3.35", :git => 'git@github.com:jdfdesign/gko_cms3.git'
	gem "gko_documents", "= 0.3.35", :git => 'git@github.com:jdfdesign/gko_cms3.git'
	gem "gko_inquiries", "= 0.3.35", :git => 'git@github.com:jdfdesign/gko_cms3.git'
	gem "gko_themes", "= 0.3.35", :git => 'git@github.com:jdfdesign/gko_cms3.git'
end
